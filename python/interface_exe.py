...
def executar_atualizacao():
    ...
    try:
        ...
        if not resumo:
            messagebox.showerror("Erro", "Não foi possível gerar o resumo da atualização.")
            return
...
frame_auth = tk.LabelFrame(janela, text="Autenticação",
                           font=("Arial", 11, "bold"))
...
entry_senha = tk.Entry(frame_auth, show="*", width=30,
                       font=("Arial", 12))
entry_senha.pack(padx=10, pady=5)

frame_periodo = tk.LabelFrame(janela, text="Período para Atualização",
                              font=("Arial", 11, "bold"))
...
tk.Label(frame_periodo, text="Data Inicial:",
         font=("Arial", 11)).grid(row=2, column=0, sticky="w", padx=10)
entry_ini = DateEntry(frame_periodo, width=12,
                      date_pattern="dd/mm/yyyy")
entry_ini.grid(row=2, column=1, padx=10)

tk.Label(frame_periodo, text="Data Final:",
         font=("Arial", 11)).grid(row=3, column=0, sticky="w", padx=10)
entry_fim = DateEntry(frame_periodo, width=12,
                      date_pattern="dd/mm/yyyy")
